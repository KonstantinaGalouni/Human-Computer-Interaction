...
<html>
	...
	<body onkeypress="GetChar (event);">
		...
		<div id="main">
			...
			<div id = "navbar">
				<a href="index_connected.php" style="text-decoration:none;">Αρχική</a> > <a href="advanced_search_connected.php" style="text-decoration:none;">Σύνθετη Αναζήτηση</a> > Αποτελέσματα Αναζήτησης
			</div>
