...
<html>
	<head>
		<title>Εύδοξος</title>
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="css/index_connected.css" />
	...
	<body>
		...
		<div id="main">
			<ul id="menuhorizontal">
				<!tr>
					<li class="tdhorizontalsmall"><a class="selected" href="index_connected.php">Αρχική</a></li>
			...
			<div id="right">
				<marquee id="announcement">
					<p behavior="slide" loop="3" width="800" style="color:orange; font-size:15px;" onmouseover = "Freeze(event)" onbounce="WriteInfo (event)" onfinish="WriteInfo (event)" onstart="WriteInfo (event)"> Οι δηλώσεις συγγραμμάτων για το εαρινό εξάμηνο έχουν ολοκληρωθεί!</p>
				</marquee>
				<div id="identity">
					<span id="question"> Τί είναι ο Εύδοξος; </span><br><br>
				...
				<div id="questions">
					<a style="text-decoration:none" href="whatever.htm">Τί μου προσφέρει ο Εύδοξος;</a><br><br>
					<a style="text-decoration:none" href="whatever.htm">Τί θα κερδίσω με τον Εύδοξο;</a>
				</div>
			</div>
