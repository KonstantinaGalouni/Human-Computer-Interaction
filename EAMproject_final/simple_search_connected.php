...
<html>
	<head>
		<title>Εύδοξος: Απλή Αναζήτηση</title>
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="css/simple_search_connected.css" />
		...
		<div id="main">
			<ul id="menuhorizontal">
				<!tr>
					...
					<li class="tdhorizontalsmall"><a class="selected" href="simple_search_connexted.php">Αναζήτηση</a></li>
			...
			<div id = "navbar">
				<a href="index_connected.php" style="text-decoration:none;">Αρχική</a> > Απλή Αναζήτηση
			</div>
