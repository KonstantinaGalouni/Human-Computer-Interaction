...
<html>
	<head>
		<title>Εύδοξος: Νέα-Ανακοινώσεις</title>
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="css/news_announcements_connected.css" />
	...
	<body>
		...
		<div id="main">
			...
			<table id="menuvertical" border="1">
				<tr>
				  <td><a style="font-weight:bold" class="cell" href="news_announcements_connected.php">Nέα-Ενημερώσεις</a></td>
				</tr>
				<tr>
			...
			<div id = "navbar">
				<a href="index_connected.php" style="text-decoration:none;">Αρχική</a> > Nέα-Ενημερώσεις 
			</div>
			
			<div id="right">
				<marquee id="announcement">
					<p behavior="slide" loop="3" style="color:orange; font-size:15px;" width="800" onmouseover = "Freeze(event)" onbounce="WriteInfo (event)" onfinish="WriteInfo (event)" onstart="WriteInfo (event)"> Οι δηλώσεις συγγραμμάτων για το εαρινό εξάμηνο έχουν ολοκληρωθεί!</p>
				</marquee>
				<ul id="newslist">
				<li><a href="whatever.htm">Διευκρινίσεις για τη διαδικασία κοστολόγησης διδακτικών βιβλίων μέσω της ηλεκτρονικής υπηρεσίας ΕΥΔΟΞΟΣ</li><br>
				<li><a href="whatever.htm">Προετοιμασία της διανομής διδακτικών συγγραμμάτων για το ακαδημαϊκό έτος 2014-2015</li><br>
				<li><a href="whatever.htm">Παράταση Περιόδου Δηλώσεων και Διανομής Συγγραμμάτων Εαρινού Εξαμήνου 2013-2014</li>
				</ul>
			</div>
